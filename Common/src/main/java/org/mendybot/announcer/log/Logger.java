package org.mendybot.announcer.log;
...
public class Logger {
	...
	/**
	 * This method is used to log a debug message if the appropriate level is
	 * let for the Logger
	 * 
	 * @param methodName
	...
	/**
	 * This method is used to log a severe message if the appropriate level is
	 * let for the Logger
	 * 
	 * @param methodName
	 *            The method the log entry was sent from
	...
	/**
	 * This method returns the current logging level for this Logger. The
	 * logging level is used to filter out log messages.
	 * 
	 * @return LogLevel
	 */
